...
<div class="row">
	<div id="ap-lists" class="<?php echo is_active_sidebar( 'ap-tag' ) && is_anspress() ? 'col-md-9' : 'col-md-12' ?>">
		<div class="ap-taxo-detail">
			<h2 class="entry-title"><?php printf(__('Question tag: %s','tags-for-anspress'), $question_tag->name); ?> <span class="ap-tax-item-count"><?php printf( _n('1 Question', '%s Questions', $question_tag->count, 'tags-for-anspress'),  $question_tag->count); ?></span></h2>
